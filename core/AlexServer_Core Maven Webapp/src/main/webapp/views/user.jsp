					...
					<tr>
						<th colspan="6">
					 			...
					 			<ul class="pagination pagination2" style="border-right: 5">
									...
									<li><a href="getUser.do?pageNum=1" class="current">1</a></li>
									<li><a href="getUser.do?pageNum=2">2</a></li>
									<li><a href="getUser.do?pageNum=3">3</a></li>
									<li><a href="getUser.do?pageNum=4">4</a></li>
									<li><a href="getUser.do?pageNum=5">5</a></li>
